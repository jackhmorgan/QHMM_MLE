...
ansatz = efficient_su2(3, reps=3, entanglement='full', su2_gates=['rz','ry','rx'])
...
for n_samples in n_samples_list:
    ...
    quantum_kl = float(kl_divergence_between_hmm(model_1, model_3, n_sequences=10))
    npc_kl = float(kl_divergence_between_hmm(model_1, model_2, n_sequences=10))
